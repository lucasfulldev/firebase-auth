...
app.get('/', (req, res) => {
  res.json({
    ...
    endpoints: {
      ...
      'POST /api/esp32/telegram/ask': 'Solicitar confirmação de cadastro via Telegram',
      'POST /api/esp32/telegram/check': 'Verificar status de confirmação Telegram',
      'POST /api/esp32/telegram/respond': 'Responder confirmação Telegram (webhook)',
...
╚════════════════════════════════════════════╝
  ...
  console.log('  POST /api/esp32/telegram/ask');
  console.log('  POST /api/esp32/telegram/check');
  console.log('  POST /api/esp32/telegram/respond');
  console.log('  POST /api/esp32/telegram/alert');
